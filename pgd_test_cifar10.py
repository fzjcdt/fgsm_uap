...
for method_name in method_names:
    ...
    for time_path in os.listdir(method_path):
        ...
        if time_path is None or os.path.exists(os.path.join(time_path, method_name + '_best_pgd_test.log')):
            continue
        ...
        # last
        if time_path is None or os.path.exists(os.path.join(time_path, method_name + '_last_pgd_test.log')):
            continue
