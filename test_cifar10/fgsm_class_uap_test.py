...
def fgsm_class_uap_test(seed=0):
    ...
    fgsm_uap = FGSM_Class_UAP(model, device=device, seed=seed)
    fgsm_uap.train(opt, scheduler, train_loader, test_loader, total_epoch=110, class_num=10)
